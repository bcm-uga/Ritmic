...
D_met and D_rna are the bulk samples, respectively for the methylome and the transcriptome of the samples. Here, we used the samples simulated in the vignette 0_simulation.Rmd.
