...
```{r,echo=TRUE}
test_matrix <- readRDS('~/Datas/projects/RiTMIC/data/res_0.8.RDS')
dim(test_matrix)
test_matrix
pre_treat_res <- RiTMIC::pre_treat(penda_res = test_matrix, patientNumber=5)
dist <- RiTMIC ::calc_dist(penda_res=pre_treat_res, matrix_A = A_60p)
pre_plot <- RiTMIC::pre_plot_res(matrix_T = )
