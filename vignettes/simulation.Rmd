...
`simu_D` is the final step of the analysis. It's the gathering of the two matrices A and T to obtain a complete RNAseq dataset. `simu_D` can be run with or without the `noise` option. 
