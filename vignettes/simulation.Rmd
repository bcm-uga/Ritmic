...
```{r, results="verbatim"}
load("~/projects/dataPenda/Data_DC_methylome.RData")
data_methyl = Data_DC_methylome[[1]]

load("~/projects/dataPenda/Data_DC_transcriptome_allgenes_notlog.RData")
...
#'
#' @param n 
#' @param alpha cell type proportions of size k
#'
#' @return proportions of different cell types
#' @export
#'
#' @examples
