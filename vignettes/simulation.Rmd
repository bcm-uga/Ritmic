...
##Simu A
```{r, results="verbatim"}
#' Simulate cell type distributions in tumours
#' Creates a new matrix with : n the number of patients and alpha the vector of cell type proportions of size k
#'
#' @param n 
...
simu_T_cancer = function(tumor_RNAseq, n){
  # n_simu return the number of new simulations 
  n_simu = n - ncol(tumor_RNAseq)
  # T_res : empty matrix with the @n parameter columns and the rows from tumor_RNAseq
  ...
  # QUESTION : debugging supposed
  t = 0
  
  for(g in rownames(tumor_RNAseq)){
    # Check the distance between genes 
