...
subtitle: "Step 2 : Analysis with PenDA (Performing personalized data analysis) and only one control sample"
...
Step 2: Analyse your dataset with PenDA

## Presentation of PenDA
...
The dataset used to perform PenDA comes from the `simulation` pipeline. 
