...
To use Penda, we need a control sample. Here, we use the example dataset penda::penda_data_ctrl, but for a real analysis you can used, for example, normal cell lines.
