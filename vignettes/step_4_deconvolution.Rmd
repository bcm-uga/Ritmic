...
# Passage de 21785 à 7750 sondes 
...
deconv = EDec::run_edec_stage_1(meth_bulk_samples = TCGA_LUAD_meth$data, informative_loci = rownames(D_FS), num_cell_types = 7)
...
pdf("heatmap_T_EDec.pdf")
heatmap(T_final_EDec$means)
dev.off()
